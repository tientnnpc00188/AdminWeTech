                ...
                <div class="tab-content">
                  <div id="working" class="container tab-pane active">
                    ...
                    <div class="table-responsive">
                      <h5 class="col-sm-2">Có <a style="color: #ED0000;">{{rowData.length}}</a> Hóa Đơn</h5>
                      <table id="shop" class="table align-items-center table-flush">
                        <thead class="thead-light">
                          <tr>
                            <th scope="col" class="sort" data-sort="name">ID</th>
                            <th scope="col" class="sort" data-sort="budget">Mã sản phẩm</th>
                            <th scope="col" class="sort" data-sort="budget">sale-quantity</th>
